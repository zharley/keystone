webpackJsonp([9],{685:function(e,t,n){"use strict"
...
return!0}var s=n(203),r=i(s),l=n(22),o=i(l),u=n(127),p=n(1),h=i(p),c=n(184),d=i(c),f=n(155),v=i(f),m=n(3),y=n(56),C=i(y)
...
C["default"].forEach(this.props.filters,function(n,i){if(C["default"].isString(n)&&":"==n[0]){var a=n.slice(1),s=e.props.values[a]
...
this.loadOptionsCallback(null,{complete:!0,options:Object.keys(this._itemsCache).map(function(e){return t._itemsCache[e]})}),this.closeCreate()},renderSelect:function(e){return h["default"].createElement(d["default"].Async,{multi:this.props.many,disabled:e,loadOptions:this.loadOptions,labelKey:"name",name:this.getInputName(this.props.path),onChange:this.valueChanged,simpleValue:!0,value:this.state.value,valueKey:"id"})},renderInputGroup:function(){var e=n(208)
return h["default"].createElement(m.InputGroup,null,h["default"].createElement(m.InputGroup.Section,{grow:!0},this.renderSelect()),h["default"].createElement(m.InputGroup.Section,null,h["default"].createElement(m.Button,{onClick:this.openCreate,type:"success"},"+")),h["default"].createElement(e,{list:u.listsByKey[this.props.refList.key],isOpen:this.state.createIsOpen,onCreate:this.onCreate,onCancel:this.closeCreate}))},renderValue:function(){return this.renderSelect(!0)},renderField:function(){return this.props.createInline?this.renderInputGroup():this.renderSelect()}})}})
